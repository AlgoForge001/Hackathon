...
// Helper to generate realistic 90-day price trend data
...
const fullCatalog = [
  // ─── ELECTRONICS (12 Product Groups) ──────────────────────────────────────
  {
    ...
    price_history: generatePriceHistory(24990, 25499, 26990),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Rahul K", rating: 5, text: "Unmatched noise cancellation and crystal clear calls.", date: "2024-10-15" },
          { author: "Priya M", rating: 4, text: "Extremely lightweight and comfortable on long flights.", date: "2024-09-22" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Karan B", rating: 5, text: "Awesome soundstage with deep sub-bass and LDAC support.", date: "2024-11-12" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Tanvi S", rating: 5, text: "Original sealed package with full Sony India 1-year warranty.", date: "2024-10-02" },
        ],
      },
    ],
  },
  {
    ...
    price_history: generatePriceHistory(19999, 20490, 21900),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Arjun V", rating: 5, text: "Transparency mode is incredible. Spatial audio with head tracking is mind blowing.", date: "2024-11-20" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Meera K", rating: 5, text: "USB-C case makes charging with Mac and iPad effortless.", date: "2024-10-18" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Rohan D", rating: 5, text: "Authentic item with AppleCare activation.", date: "2024-12-01" },
        ],
      },
    ],
  },
  {
    ...
    price_history: generatePriceHistory(84990, 83990, 87900),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Kunal J", rating: 5, text: "Fast compilation and 16 hours real world battery life. Perfect machine.", date: "2024-11-10" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Ananya P", rating: 5, text: "Midnight finish is gorgeous. Fanless design means zero noise.", date: "2024-10-28" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Devendra R", rating: 5, text: "Original packaging and verified battery health.", date: "2024-11-15" },
        ],
      },
    ],
  },
  {
    ...
    price_history: generatePriceHistory(119999, 118499, 122999),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Sameer N", rating: 5, text: "Galaxy AI zoom photography and Circle to Search work flawlessly.", date: "2024-11-18" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Deepak G", rating: 5, text: "Flat display with anti-reflective glass makes outdoor viewing crystal clear.", date: "2024-10-30" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Pradeep T", rating: 5, text: "Titanium build feels luxurious in the hand.", date: "2024-11-04" },
        ],
      },
    ],
  },
  {
    ...
    price_history: generatePriceHistory(154990, 152990, 159990),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Varun K", rating: 5, text: "OLED panel is breathtaking. Runs Cyberpunk over 75fps with DLSS.", date: "2024-11-15" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Aditya N", rating: 5, text: "CNC aluminum body is rock solid and very portable.", date: "2024-10-25" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Kunal M", rating: 5, text: "Slash lighting strip looks amazing.", date: "2024-11-20" },
        ],
      },
    ],
  },
  {
    ...
    price_history: generatePriceHistory(49990, 48990, 51990),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Nikhil K", rating: 5, text: "Spider-Man 2 and God of War look incredible at 4K 60fps.", date: "2024-11-14" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Siddharth B", rating: 5, text: "Much smaller and lighter than original launch PS5.", date: "2024-10-25" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Gaurav S", rating: 5, text: "Fast delivery with secure seal intact.", date: "2024-11-20" },
        ],
      },
    ],
  },
  {
    ...
    price_history: generatePriceHistory(38999, 37990, 39900),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Vishal M", rating: 5, text: "Double tap gesture is super useful while cooking or driving.", date: "2024-11-09" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Kavita S", rating: 5, text: "Fitness tracking is unmatched.", date: "2024-10-15" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Varun P", rating: 4, text: "Fast charging gets it to 80% in 45 mins.", date: "2024-11-02" },
        ],
      },
    ],
  },
  {
    ...
    price_history: generatePriceHistory(13999, 14499, 14999),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Nandita S", rating: 5, text: "Adjustable warm light makes bedtime reading effortless.", date: "2024-11-22" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Aman G", rating: 5, text: "Battery lasts for weeks on a single charge.", date: "2024-10-09" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Prachi M", rating: 4, text: "Type C port charging is great.", date: "2024-11-01" },
        ],
      },
    ],
  },

  // ─── FOOTWEAR (9 Product Groups with Verified Multi-Angle Images) ──────────
  {
    ...
    brand: "Nike",
    images: [
      "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=900&auto=format&fit=crop&q=80", // iconic red/black side profile
      "https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?w=900&auto=format&fit=crop&q=80", // top angle
      "https://images.unsplash.com/photo-1515955656352-a1fa3ffcd111?w=900&auto=format&fit=crop&q=80", // heel air unit
      "https://images.unsplash.com/photo-1584735935682-2f2b69dff9d2?w=900&auto=format&fit=crop&q=80", // lifestyle street on-foot
    ],
    ...
    price_history: generatePriceHistory(11495, 11995, 10995),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Rohit K", rating: 5, text: "Best cushioning in a lifestyle shoe. Extremely stylish.", date: "2024-11-16" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Ajay S", rating: 4, text: "Recommend sizing half up for wider feet.", date: "2024-10-24" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Vikas M", rating: 5, text: "Lowest price on Myntra with instant bank discounts.", date: "2024-11-28" },
        ],
      },
    ],
  },
  {
    ...
    price_history: generatePriceHistory(12999, 13499, 12499),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Karthik R", rating: 5, text: "Light BOOST foam gives explosive energy return for 10k runs.", date: "2024-11-19" },
        ],
      },
      {
        platform: "flipkart",
      ...
      },
      {
        ...
        reviews: [
          { author: "Dheeraj S", rating: 5, text: "Feels like walking on clouds with high arch support.", date: "2024-11-22" },
        ],
      },
    ],
  },
  {
    ...
    price_history: generatePriceHistory(3499, 3799, 3649),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Vikram S", rating: 5, text: "Built like a tank. Withstood rocky trails with zero tearing.", date: "2024-11-08" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Ankur J", rating: 4, text: "High ankle collar prevents sprains on steep descents.", date: "2024-10-15" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Devashish T", rating: 5, text: "Premium nubuck suede texture.", date: "2024-11-20" },
        ],
      },
    ],
  },
  {
    ...
    dimensions: { width: "11.5 cm", height: "10.0 cm", depth: "28.5 cm", weight: "185g per clog" },
    specs: {
    ...
    price_history: generatePriceHistory(2495, 2295, 2395),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Deepa N", rating: 5, text: "Ultimate comfort for home and rain.", date: "2024-11-11" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Manish B", rating: 4, text: "Cleans with running water in seconds.", date: "2024-10-20" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Pradeep G", rating: 5, text: "Genuine tags and pristine quality.", date: "2024-11-27" },
        ],
      },
    ],
  },

  // ─── FASHION (6 Product Groups with Verified Multi-Angle Images) ───────────
  {
    ...
    dimensions: { width: "38.0 cm", height: "105.0 cm", depth: "2.0 cm", weight: "550g" },
    specs: {
    ...
    price_history: generatePriceHistory(2199, 2399, 1999),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Alok N", rating: 5, text: "Classic 511 fit. Perfect stretch that holds form.", date: "2024-11-12" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Harish S", rating: 4, text: "Rich indigo color looks great with white sneakers.", date: "2024-10-29" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Yash P", rating: 5, text: "50% discount on Myntra with genuine red tab.", date: "2024-11-24" },
        ],
      },
    ],
  },
  {
    ...
    dimensions: { width: "14.0 cm", height: "5.0 cm", depth: "13.5 cm", weight: "31g" },
    specs: {
    ...
    price_history: generatePriceHistory(8490, 8890, 8190),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Aditya S", rating: 5, text: "Glare reduction while highway driving is outstanding.", date: "2024-11-21" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Kunal M", rating: 5, text: "Original leather case and microfiber cloth included.", date: "2024-10-14" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Tarun D", rating: 5, text: "Authentic Luxottica barcode verified.", date: "2024-11-26" },
        ],
      },
    ],
  },

  // ─── HOME & LIVING (6 Product Groups with Verified Multi-Angle Images) ─────
  {
    ...
    dimensions: { width: "120.0 cm", height: "35.0 cm", depth: "120.0 cm", weight: "4.2 kg" },
    specs: {
    ...
    price_history: generatePriceHistory(3699, 3549, 3890),
    platforms: [
      {
        platform: "amazon",
      ...
      },
      {
        ...
        reviews: [
          { author: "Sunil K", rating: 5, text: "Remote works from any corner of the room.", date: "2024-10-18" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Archana S", rating: 4, text: "Sleek look on false ceiling.", date: "2024-11-09" },
        ],
      },
    ],
  },
  {
    ...
    dimensions: { width: "35.5 cm", height: "33.8 cm", depth: "35.5 cm", weight: "4.55 kg" },
    specs: {
    ...
    price_history: generatePriceHistory(7999, 7699, 8490),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Pooja V", rating: 5, text: "Fries and chicken tikka turn out crispy with 1 spoon oil.", date: "2024-11-20" },
        ],
      },
      {
        platform: "flipkart",
      ...
      },
      {
        ...
        reviews: [
          { author: "Komal D", rating: 4, text: "Very convenient for healthy daily cooking.", date: "2024-11-15" },
        ],
      },
    ],
  },
  {
    ...
    price_history: generatePriceHistory(29900, 28990, 31900),
    platforms: [
      {
        platform: "amazon",
        ...
        reviews: [
          { author: "Vivek G", rating: 5, text: "Deep cleans sofas and carpets with ease.", date: "2024-11-18" },
        ],
      },
      {
        platform: "flipkart",
        ...
        reviews: [
          { author: "Ananya B", rating: 5, text: "Pet hair removal is instantaneous.", date: "2024-10-30" },
        ],
      },
      {
        platform: "myntra",
        ...
        reviews: [
          { author: "Karan T", rating: 5, text: "Lightweight and easy to carry upstairs.", date: "2024-11-22" },
        ],
      },
    ],
  },
...
console.log(`✅ Saved ${fullCatalog.length} product groups with 4-image arrays & price history to ${backendPath}`);
